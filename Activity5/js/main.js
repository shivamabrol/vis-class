...
function drawChart(data){
	...
	// CREATE a yScale using d3.scaleLinear, with domain [ max year, min year] and range [0, height]  
	// Note- why did I reverse the domain going from max to min? -> cause 2017 at the top of the table
	...
	const min = d3.min(data, d => d.cost);
